...
import { MessageSquare, Loader2, Copy, Check, Lightbulb } from "lucide-react";
...
export default function NegotiationCoach() {
  ...
  const coachMutation = useMutation({
    mutationFn: async (counterpartyMessage: string) => {
      const response = await apiRequest("POST", "/api/negotiation-coach", { 
